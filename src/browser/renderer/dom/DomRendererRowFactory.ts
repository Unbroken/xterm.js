    ...
    for (let x = 0; x < lineLength; x++) {
      ...
      switch (bgColorMode) {
        ...
        case Attributes.CM_RGB:
          ...
          this._addStyle(charElement, `background-color:${toCssColor(`#${padStart((bg >>> 0).toString(16), '0', 6)}`, this._optionsService.rawOptions.colorSpace)}`);
          break;
      ...
      switch (fgColorMode) {
        ...
        case Attributes.CM_RGB:
          ...
          if (!this._applyMinimumContrast(charElement, resolvedBg, color, cell, bgOverride, fgOverride)) {
            this._addStyle(charElement, `color:${toCssColor(`#${padStart(fg.toString(16), '0', 6)}`, this._optionsService.rawOptions.colorSpace)}`);
          }
          break;
        case Attributes.CM_DEFAULT:
        default:
