...
export class SixelHandler implements IDcsHandler, IResetHandler {
  ...
  public unhook(success: boolean): boolean | Promise<boolean> {
    ...
    canvas.getContext('2d', { colorSpace: this._coreTerminal._core.optionsService.rawOptions.colorSpace })?.putImageData(new ImageData(this._dec.data8 as Uint8ClampedArray<ArrayBuffer>, width, height), 0, 0);
